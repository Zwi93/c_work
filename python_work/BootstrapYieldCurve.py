# -*- coding: utf-8 -*-
"""
Created on Tue Jul 23 10:59:33 2019
...
class BootstrapYieldCurve():
    ...
    def __init__(self):
        self.zero_rates = dict()  # Empty dictionary to store zero rates
        self.instruments = dict()  # Empty dictionary to store instruments
    ...
    def zero_coupon_spot_rate(self, par, price, T):
        """ Get zero rate of zero coupon bond """
